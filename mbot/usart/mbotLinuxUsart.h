...
extern void usartSendData(USART_TypeDef* USARTx,short leftVel, short rightVel,short angle,short vol,float qx,float qy,float qz,float qw,unsigned char ctrlFlag); 
//发送指定字符数组的函数
